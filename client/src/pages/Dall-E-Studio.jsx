...
import genartsample from '../assets/images/Sample-Image3.jpg';
      ...
      >
        <div className="relative group">
          <input
            ...
            disabled={isGenerating} // Disable the input during generation.
